...
GROMACS_TRAJ = (_data_ref / "gromacs" / "md" / "gromacs_v3.trr").as_posix()
GROMACS_TOPOL = (_data_ref / "gromacs" / "md" / "gromacs_struct.gro").as_posix()
GROMACS_TPR = (_data_ref / "gromacs" / "md" / "gromacs_v3.tpr").as_posix()
